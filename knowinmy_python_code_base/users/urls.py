...
urlpatterns = [
    ...
    path('review-ds/', review_dynamic_subscription, name='review_ds'),
    path('pdf/', generate_pdf_file,name="pdf"), 
    ...
    path('<slug:slug>/edit-mentor/', edit_mentor, name='edit_mentor'),
